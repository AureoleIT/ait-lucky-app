...
export default function LuckySpinSetting({router}) {
    ...
    return (
        <div className="flex flex-col px-3 gap-4">
            <audio loop className="hidden" id="gameMusic">
                <source src="https://joeybabcock.me/blog/wp-content/uploads/2019/05/lobby-classic-game-halloween.mp3" type="audio/mpeg"></source>
            </audio>
            <audio loop className="hidden" id="gameSound">
                <source src="https://joeybabcock.me/blog/wp-content/uploads/2019/05/lobby-classic-game-halloween.mp3" type="audio/mpeg"></source>
            </audio>
            <div className="flex gap-2">
                <label htmlFor="gameMusicVolume" className={!muteMusic?"bg-[#40BEE5] w-10 h-10 p-2 rounded-full":"bg-[#888] w-10 h-10 p-2 rounded-full"}
            ...
            <div className="flex gap-2">
                <label htmlFor="gameSoundVolume" className={!muteSound?"bg-[#40BEE5] w-10 h-10 p-2 rounded-full":"bg-[#888] w-10 h-10 p-2 rounded-full"}
                ...
                <input type="range" id="gameSoundVolume" name="gameSoundVolume" min="0" max="10" defaultValue="8" className="grow muteInput"
