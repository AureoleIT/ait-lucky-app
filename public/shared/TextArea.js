...
export default function AuthInput({content, row}) {
    ...
    return (
        <div className="bg-gradient-to-r from-[#003B93] to-[#00F0FF] p-[2px] h-full w-full rounded-[10px] py-[2px] outline-none relative">
            <div className="h-full w-full">
                <textarea className="h-full w-full rounded-lg px-2 py-2 outline-none border-none" rows={row} value={text} onChange={(e) => setText(e.target.value)}/>
