  ...
  return (
    <div className="flex flex-col justify-evenly items-center h-screen w-screen">
      ...
      <div className="flex justify-between w-3/4 lg:w-4/12 text-lg">
        <h1 className="uppercase py-2 mb-1 font-bold text-[#004599]">
          mã sự kiện
        </h1>
        <h1 className="uppercase py-2 font-bold text-[#004599] tracking-[5px]">
          {eventID}
        </h1>
      </div>
      {/* rewards information */}
      <h1 className="uppercase text-[#004599] font-bold mb-1 text-[20px]">
      ...
      <div className="flex items-center w-full justify-center mb-2">
        <div className="flex items-center justify-center h-[40px]">
          <h1 className="uppercase text-[#004599] font-bold mb-1">
            thời gian check in
          </h1>
        </div>
        <div
          className="text-white font-bold ml-3 w-[110px] h-[40px] flex justify-center items-center rounded-[10px] "
          style={optionStyles}
        >
          <select
      ...
      <div className="w-11/12 lg:w-4/12 max-w-xl flex justify-center items-center">
        ...
        <div
          className="w-[50px] h-[50px] bg-gradient-to-r from-[#003B93] to-[#00F0FF] rounded-[50px] ml-1 cursor-pointer drop-shadow-lg"
