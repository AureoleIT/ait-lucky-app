                ...
                <section className="relative h-screen px-5 py-5 mx-auto flex justify-center items-center max-w-md max-md:w-full">
                    <div className="flex flex-col justify-start items-center w-full h-full overflow-auto">
                        ...
                        <div className="w-full mb-16">
                            ...
                            <Button content={trans.exitButton} primaryColor={"#FF6262"} isSquare={true} margin={"my-0"} onClick={() => { document.getElementById("exitOverlay").classList.remove('hidden') }} />
                        </div>
                        <div className="absolute right-2 top-2 rounded-full h-10 w-10 bg-gradient-to-r from-[#003B93] to-[#00F0FF] p-1"
                            onClick={() => { document.getElementById("settingOverlay").classList.remove('hidden') }}>
